...
import forum.jiangyouluntan.com.videocropdemo.listVideo.visibility.items.ListItemData;
import forum.jiangyouluntan.com.videocropdemo.listVideo.visibility.scroll.ItemsPositionGetter;
import forum.jiangyouluntan.com.videocropdemo.listVideo.visibility.scroll.ItemsProvider;
...
//    @Override
//    public void onScrollStateIdleActive(boolean isShouldActive) {
//        if (!mCurrentItem.isVisibleItemChanged() && isShouldActive) {
//            if(SHOW_LOGS) {
//                Log.d(TAG, "onScrollStateIdle " + mCurrentItem + " "
//                        + VisibilityPercentsCalculator.getVisibilityPercents(mCurrentItem.getView(),
//                        mCurrentItem.getListItem()) + " " + mPreActiveItem + " "
