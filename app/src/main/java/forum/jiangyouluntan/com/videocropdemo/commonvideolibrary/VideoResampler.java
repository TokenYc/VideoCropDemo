...
package forum.jiangyouluntan.com.videocropdemo.commonvideolibrary;
...
public class VideoResampler {
   ...
   public static final int WIDTH_420P = 960;
   public static final int HEIGHT_420P = 540;
   public static final int BITRATE_420P = 1200000;
   ...
   private int mWidth = WIDTH_420P;
   private int mHeight = HEIGHT_420P;

   // bit rate, in bits per second
   private int mBitRate = BITRATE_420P;
