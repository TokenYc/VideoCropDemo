        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        MediaCodecActivity.this.finish();
                    }
                })
                .create()
                .show();
    ...
    private void getVideoAllImage() {
        ...
        try {
            FfmpegController fc = new FfmpegController(
                    MediaCodecActivity.this, fileAppRoot);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    File fileAppRoot = new File(
                            getApplicationInfo().dataDir);
                    FfmpegController ffmpegController = new FfmpegController(MediaCodecActivity.this, fileAppRoot);
